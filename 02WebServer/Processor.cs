...
namespace WebServer
{
    public class Processor
    {
        ...
        public Processor(Socket clientSocket, string contentPath)
        {
            ...
            Console.WriteLine("FileHandler{0}", FileHandler);
        }
        ...
        public void RequestUrl(string requestedFile)
        {
            ...
            if (dotIndex > 0)
            {
                if (FileHandler.DoesFileExists(requestedFile))    //If yes check existence of the file
                    ...
                    SendErrorResponse(ClientSocket);      // We don't support this extension.
            }
        ...
        private void SendErrorResponse(Socket clientSocket)
        {
