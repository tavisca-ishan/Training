...
namespace Tavisca.EmployeeManagement.BusinessLogic
{
    public class EmployeeManager : IEmployeeManager
    {
        ...
        public List<Remark> GetRemarks(string employeeId)
        {
            return _storage.GetRemarks(employeeId);
        }
        public Pagination GetPageRemarks(string employeeId, string pageNumber)
        {
            return _storage.GetPageRemarks(employeeId, pageNumber);
        }
    }
}
