    ...
    public class EmployeeStorage : IEmployeeStorage
    {
        ...
        public Model.Employee Save(Model.Employee employee)
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand("insert into emp_data values(@emp_id,@title,@firstName,@lastName,@emailId,@phone,@joining_date)", connect);
                ...
                SqlParameter p5 = new SqlParameter("emailId", employee.Email);
                ...
                SqlCommand commandRemark = new SqlCommand("insert into empRemark values(@EmpId,@AddRemark)", connect);
                while (employee.Remarks != null)
                {
                    foreach (var empRemark in employee.Remarks)
                    {
                        SqlParameter p8 = new SqlParameter("EmpId", employee.Id);
                        SqlParameter p9 = new SqlParameter("AddRemark", empRemark.Text);
                        SqlParameter p10 = new SqlParameter("RemarkTime", empRemark.CreateTimeStamp);
        ...
        public Model.Employee Get(string employeeId)
        {
            try
            {
                ...
                SqlConnection conEmployee = new SqlConnection("Data Source=TRAINING11;Initial Catalog=WCFEmployee;Persist Security Info=True;User ID=sa;Password=test123!@#");
                conEmployee.Open();
                ...
                SqlConnection conRemark = new SqlConnection("Data Source=TRAINING11;Initial Catalog=WCFEmployee;Persist Security Info=True;User ID=sa;Password=test123!@#");
                conRemark.Open();
                SqlCommand cmdGetRemark = new SqlCommand("select * from remark_data where emp_id='" + emp.Id + "'", conRemark);
        ...
        public List<Model.Employee> GetAll()
        {
            try
            {
                ...
                SqlConnection conAllEmployee = new SqlConnection("Data Source=TRAINING11;Initial Catalog=WCFEmployee;Persist Security Info=True;User ID=sa;Password=test123!@#");
                conAllEmployee.Open();
