    ...
    public partial class ViewRemark : System.Web.UI.UserControl,IWidget
    {
...

        {
            if (!IsPostBack)
            {
                ...
                emp_id = cookie2["empid"];
                var empResponse = Pagination.GetPageRemarks(emp_id, "1");
        ...
        protected void GridView1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            var empResponse = Pagination.GetPageRemarks(emp_id, Convert.ToString(GridView1.PageIndex));
            if (empResponse.ResponseStatus.Code == "500")
            {
                Response.Write(empResponse.ResponseStatus.Message);
            }
