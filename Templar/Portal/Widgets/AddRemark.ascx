...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="DDLSelectEmployee" runat="server" OnSelectedIndexChanged="DDLSelectEmployee_SelectedIndexChanged" ValidationGroup="AddRemark" DataTextField="Value" DataValueField="Key">
